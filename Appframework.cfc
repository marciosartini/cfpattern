 <cfcomponent displayname="Pattern" output="true">
			...
			<cffunction name="fw_OnApplicationStart" access="public" returntype="boolean" output="false" >
			...
			<cffunction name="fw_onRequestStart" access="public" output="false" hint="Executa sempre que uma requisi̤̣o ̩ feita.">
